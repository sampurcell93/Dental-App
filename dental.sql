...
--
-- Host: localhost    Database: sampurce_dental
-- ------------------------------------------------------
...
DROP TABLE IF EXISTS `1_3_7`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `1_3_7` (
  `This_is_the_single_tooth_test` text
...
LOCK TABLES `1_3_7` WRITE;
/*!40000 ALTER TABLE `1_3_7` DISABLE KEYS */;
INSERT INTO `1_3_7` VALUES ('<h3>Another test header.</h3>\r\nThere is still a need for another level of hierarchy display; We\'ll get to that.');
/*!40000 ALTER TABLE `1_3_7` ENABLE KEYS */;
UNLOCK TABLES;
...
DROP TABLE IF EXISTS `1_4`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `1_4` (
  `Header 1` text CHARACTER SET utf8 NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `1_4` WRITE;
/*!40000 ALTER TABLE `1_4` DISABLE KEYS */;
INSERT INTO `1_4` VALUES ('<h3>There must be a header.</h3>\r\n<p><strong>Pellentesque habitant morbi tristique</strong> senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. <em>Aenean ultricies mi vitae est.</em> Mauris placerat eleifend leo. Quisque sit amet est et sapien ullamcorper pharetra. Vestibulum erat wisi, condimentum sed, <code>commodo vitae</code>, ornare sit amet, wisi. Aenean fermentum, elit eget tincidunt condimentum, eros ipsum rutrum orci, sagittis tempus lacus enim ac dui. <a href=\"#\">Donec non enim</a> in turpis pulvinar facilisis. Ut felis.</p>\r\n\r\n<h2>Header Level 2</h2>\r\n	       \r\n<ol>\r\n   <li>Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</li>\r\n   <li>Aliquam tincidunt mauris eu risus.</li>\r\n</ol>\r\n\r\n<blockquote><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus magna. Cras in mi at felis aliquet congue. Ut a est eget ligula molestie gravida. Curabitur massa. Donec eleifend, libero at sagittis mollis, tellus est malesuada tellus, at luctus turpis elit sit amet quam. Vivamus pretium ornare est.</p></blockquote>\r\n\r\n<h3>Header Level 3</h3>\r\n\r\n<ul>\r\n   <li>Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</li>\r\n   <li>Aliquam tincidunt mauris eu risus.</li>\r\n</ul>\r\n\r\n');
/*!40000 ALTER TABLE `1_4` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `2_6`
--

DROP TABLE IF EXISTS `2_6`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `2_6` (
  `This_is_my_header` text
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `2_6`
--

LOCK TABLES `2_6` WRITE;
/*!40000 ALTER TABLE `2_6` DISABLE KEYS */;
INSERT INTO `2_6` VALUES ('<h3>The app relies on correct data input.</h3>\r\n\r\nWe are working hard on sanitation of data input.');
/*!40000 ALTER TABLE `2_6` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `appendix` VALUES (1,'High noble metal alloys','noble metal content of at least 60 wt%, of which at least 40 wt % is gold. There are\r\nthree subclasses: <ol> <li>Gold-platinum</li><li>Gold-palladium </li> <li>Gold-copper-silver-palladium</li></ol>'),(2,'Noble metal alloys','at least 25 wt % noble metal. There are three subclasses:<ol> <li>Gold-copper-silver-\r\npalladium</li><li>Palladium-copper-gallium</li><li>Palladium-silver and Silver-palladium</li></ol>'),(3,'Base-Metal Alloys','less than 25 wt % noble metal. There are three subclasses: <ol> <li>Nickel-chromium-\r\nberyllium</li><li>Nickel-chromium (with higher or lower chromium content)</li> <li>Cobalt-chromium</li></ol>');
...
-- Dump completed on 2012-11-19  1:14:12
