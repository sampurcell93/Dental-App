...
--
-- Host: localhost
-- Generation Time: Oct 12, 2012 at 07:43 PM
...
(1, 'High noble metal alloys', 'noble metal content of at least 60 wt%, of which at least 40 wt % is gold\n(three subclasses: i) Gold-platinum, ii) Gold-palladium, iii) Gold-copper-silver-palladium'),
(2, 'Noble metal alloys', 'at least 25 wt % noble metal (three subclasses: i) Gold-copper-silver-\npalladium, ii) Palladium-copper-gallium, iii) Palladium-silver and Silver-palladium)'),
(3, 'Base-Metal Alloys', 'less than 25 wt % noble metal (three subclasses- i) Nickel-chromium-\nberyllium, ii) Nickel-chromium (with higher or lower chromium content), iii) Cobalt-chromium)');
